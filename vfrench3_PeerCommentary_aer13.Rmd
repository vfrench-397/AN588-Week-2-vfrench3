---
title: "vfrench3_PeerCommentary_aer13"
...
```
A: might be useful to explain what the function length() does here, in case someone less familiar with R is trying to follow your code 
...
```{r}
#str function displays internal structure of an R object. Our first variable V1 (column 1) is numeric, V2 is logical and V3 is a factor with 2 levels. 5 observations (rows) of 3 variables (columns)
str(m3)
```

## My Biggest Challenges:

1. Coercion during Challenge 5 was confusing as none of my verifying statements were returning true. I realized I wasn't assigning the coercion functions to a variable and therefore my verification functions were reading the original object before coercion. 
...
## Peer Commentary 
1.You commented you code very well, you did a really good job explaining all of the functions and important elements within your code! Going through your code gave me a better sense of how I can comment my code better in the future 
2. I also struggled with coersing vectors into factor and logical vectors in challenge 5, and working through your solutions was really helpful! I ended up just adding an additional column to my data frame. 
3. Finally, your code was well commented and really easy to follow! Good job! 
